...
-- ============================================
-- OPTIONAL: Subscription History Table
-- ============================================
-- Uncomment if you want to track subscription history
...
-- CREATE INDEX IF NOT EXISTS idx_subscription_history_user_id ON public.subscription_history("userId");
-- COMMENT ON TABLE public.subscription_history IS 'Historical record of user subscription changes';
