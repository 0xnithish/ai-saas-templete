...
import { renderPasswordResetEmail, renderVerifyEmail } from "./email-renderer";
...
export const auth = betterAuth({
  ...
  emailAndPassword: {
    ...
    sendResetPassword: async ({ user, url }: { user: { email: string }; url: string }) => {
      ...
      // Render React Email template to HTML using @react-email/components
      // Template: better-auth/PasswordReset.tsx
      // Customize appearance via design-systems/better-auth/better-auth-design-system.ts
  ...
  emailVerification: {
    ...
    sendVerificationEmail: async ({ user, url }: { user: { email: string }; url: string }) => {
      ...
      // Render React Email template to HTML using @react-email/components
      // Template: better-auth/VerifyEmailLink.tsx
      // Customize appearance via design-systems/better-auth/better-auth-design-system.ts
